...
export default function RegisterPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      toast.success("Account created! Welcome to InterviewGPT.");
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary via-primary/90 to-violet-600 relative overflow-hidden">
        ...
        <div className="relative flex flex-col justify-center px-16 text-white">
          ...
          <p className="text-white/70 text-lg leading-relaxed max-w-md">
            Create your free account and begin practicing with AI-powered mock
            interviews tailored to your experience.
          </p>
        </div>
      </div>
        ...
        >
          ...
          <Card className="border-0 shadow-none lg:border lg:shadow-sm">
            <CardHeader className="px-0 lg:px-6">
              ...
              <CardDescription>
                Get started with AI-powered interview preparation
              </CardDescription>
            </CardHeader>
